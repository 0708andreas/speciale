...
In this section, we prove results that we need in the main text, but don't fit in the flow if the text. These are well-known results, which nevertheless aren't usually covered in introductionary algebra courses. Hence, we present them here.
