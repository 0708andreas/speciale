...
\begin{proof}\colorbox{red}{Der mangler lidt her}
  %Since $\sigma_{\alpha}(G)$ is a Gröbner basis of $\langle \sigma_{\alpha}(G) \rangle$, we have that $\sigma_{\alpha}(r)$ is either $0$ or no term of $\sigma_{\alpha}(r)$ is divisible by any $\LM(\sigma_{\alpha}(g_{i}))$. If $\sigma_{\alpha}(r) = 0$, then $\sigma_{\alpha}(f) \in \langle \sigma_{\alpha}(G) \rangle$, hence $\sigma_{\alpha}(r') = 0$, since otherwise $\sigma_{\alpha}(c'f)$ wouldn't be in $\langle \sigma_{\alpha}(G) \rangle$. So assume $\sigma_{\alpha}(r) \neq 0 \neq \sigma_{\alpha}(r')$ and thus no term of either of them is divisible by any $\LM(\sigma_{\alpha}(g_{i}))$.
